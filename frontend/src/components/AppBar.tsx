    ...
    return(
        <div className="border border-slate-500 h-16 flex justify-between mb-10">
           ...
           <div className="mr-10">
            ...
            <button className="bg-red-500 rounded-lg p-2 hover:bg-red-800 m-2 " onClick={()=>{localStorage.removeItem('Medium-Blog-Application');navigate("/"); toast.success('Logout Successful'); }}>Logout</button>
